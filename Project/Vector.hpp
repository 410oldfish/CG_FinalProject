...
template <typename T>
inline TVector2<T> operator-(const TVector2<T> &v, double s) {
    return TVector2<T>(v.x - s, v.y - s);
}

template <typename T>
inline TVector2<T> operator-(double s, const TVector2<T> &v) {
...
template <typename T>
inline TVector3<T> operator-(double s, const TVector3<T> &v) {
    return TVector3<T>(s - v.x, s - v.y, s - v.z);
}

template <typename T>
inline TVector3<T> operator-(const TVector3<T> &v, double s) {
    return TVector3<T>(v.x - s, v.y - s, v.z - s);
}
