...
public:
    ...
    float get_light_pdf(const Intersection& lightInter, const Vector3f& shadingPoint) const;
    bool shadow_ray_test_point(Vector3f hit_point, Vector3f light_dir, Vector3f normal) const;
