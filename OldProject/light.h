...
using Light = std::variant<DiffuseAdoubleight, Envmap>;

/// Computes the total power the light emit to all positions and directions.
/// Useful for sampling.
double light_power(const Light &light, const Scene &scene);
...
double pdf_point_on_light(const Light &light,
