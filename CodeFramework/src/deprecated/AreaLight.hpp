...
public:
    ...
    // @param i is the intensity of the light
    AreaLight(const Vector3f &p, const Vector3f &i) : PointLight(p, i) // to point light constructor
    {
        normal = Vector3f(0, -1, 0);
        u = Vector3f(1, 0, 0);
        v = Vector3f(0, 0, 1);
        length = 100; // 100 x 100, facing down
    }
